...
For testing and evaluation purposes you can use [RhoconnectJavaSample](https://github.com/shurab/RhoconnectJavaSample) application as a starting point before continuing with the following steps. If you wish you look at the same [application](https://github.com/shurab/RhoconnectJavaPluginDemo) after it's integrated with rhoconnect-java plugin and walk through the code.
